...
function WebRtc() {
    ...
    useEffect(() => {
        ...
        navigator.mediaDevices.getUserMedia({ video: { facingMode: { exact: facingMode } }, audio: true }).then(async streams => {
    ...
    return (
        <>
            <div onMouseMove={handleMouseMove}>
                ...
                {showButton && <button style={{ position: "absolute", bottom: "17%", left: "47%" }} onClick={startConnection}>JOIN</button>}
            </div>
